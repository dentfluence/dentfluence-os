...
class TreatmentMedia extends Model
{
    ...
    public const TYPE_LABELS = [
        ...
        'pre_care_sheet'   => 'Pre-Care Sheet (PDF)',
        'post_care_sheet'  => 'Post-Care Sheet (PDF)',
        'protocol_doc'     => 'Protocol Document',
        'marketing_doc'    => 'Marketing / Patient Education',
    ];
    ...
    public const TYPE_ICONS = [
        ...
        'marketing_doc'    => '<path d="M22 12h-4l-3 9L9 3l-3 9H2"/>',
    ];
