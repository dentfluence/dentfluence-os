...
// Legacy service — logic being migrated to RulesEngine (Phase 5).
// Keep until fully migrated. Do NOT add new rules here.
// New automation rules belong in config/relationship_rules.php['rules']
// and are evaluated by app/Services/Relationship/RulesEngine.php.
// See docs/plan-relationship-engine-v1.md Phase 5 for migration notes.
