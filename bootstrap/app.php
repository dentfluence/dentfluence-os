...
return Application::configure(basePath: dirname(__DIR__))
    ->withRouting(
        ...
        then: function () {
            ...
            Route::middleware('web')->group(base_path('app/Modules/Hq/Routes/hq.php'));            // Dentfluence HQ / command center — auth + superadmin inside
    ...
    ->withMiddleware(function (Middleware $middleware): void {
        ...
        $middleware->alias([
            ...
            'superadmin'           => \App\Modules\Hq\Middleware\EnsureIsSuperadmin::class, // Dentfluence-internal HQ gate (is_superadmin flag)
        ]);
        ...
        // No upload anywhere may carry PHP/HTML/SVG/JS (Signal Board 2A.3).
        $middleware->appendToGroup('web', \App\Http\Middleware\RejectDangerousUploads::class);
        $middleware->appendToGroup('api', \App\Http\Middleware\RejectDangerousUploads::class);
    })
