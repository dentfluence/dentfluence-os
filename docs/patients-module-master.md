...
**Current status.** All four phases complete. Module **FROZEN**.
...
|---|---|---|
| KD-1 | Duplicate Wallet tab panel (two `wallet` blocks, preserved verbatim) | Pre-existing; removal is a visible change needing CEO sign-off |
| KD-2 | `treatment-plan-tab.blade.php.bak_v1` dead backup file | Deletion wasn't in authorized scope |
