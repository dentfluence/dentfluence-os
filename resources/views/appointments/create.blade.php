    ...
    <div class="max-w-3xl mx-auto px-6 py-10">
        ...
        <div class="bg-white border border-[#e8d5f0] shadow-sm"
            ...
            <div class="border-b border-[#e8d5f0] px-8 py-6">
                <h2 class="font-['Cormorant_Garamond'] text-lg font-semibold text-[#380740] mb-4 uppercase tracking-widest text-xs" style="font-family:'DM Sans',sans-serif;font-size:10px;letter-spacing:.12em;color:#6a0f70;">
                    Patient
                </h2>
    ...
    Alpine.data('appointmentForm', () => ({
        ...
        selectHighlighted() {
            if (this.highlighted >= 0 && this.results[this.highlighted]) {
                this.selectPatient(this.results[this.highlighted]);
            }
        }
    }));
});
