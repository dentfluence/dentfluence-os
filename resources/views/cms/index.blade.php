...
<style>
    ...
    * { box-sizing: border-box; }
    ...
    .df-select {
        ...
        font-size: 12px; color: #374151; font-family: 'DM Sans', sans-serif;
    ...
    .search-input {
        ...
        font-family: 'DM Sans', sans-serif; color: #374151; outline: none;
        transition: border-color .15s;
    }
    ...
    .drawer-tab { padding: 8px 12px; font-size: 11px; font-weight: 600; color: #9ca3af; border-bottom: 2px solid transparent; cursor: pointer; transition: all .12s; background: none; border-top: none; border-left: none; border-right: none; font-family: 'DM Sans', sans-serif; }
            ...
            <div class="filter-row">
                ...
                <div class="filter-group">
                    ...
                    <div style="display:flex;align-items:center;gap:6px;border:1px solid #e5e7eb;border-radius:5px;padding:5px 10px;background:white;min-width:180px;">
                        ...
                        <input type="date" style="border:none;outline:none;font-size:11px;color:#374151;font-family:'DM Sans',sans-serif;" x-model="filters.date_from" @change="doSearch()">
                    </div>
                </div>
            ...
            <div class="cms-drawer" :class="selectedCaseId ? '' : 'hidden'" id="cms-drawer">
                <template x-if="selectedCaseId && caseData">
                    <div>
                        ...
                        <div x-show="drawerTab==='notes'" style="padding:16px;">
                            <textarea style="width:100%;border:1px solid #e5e7eb;border-radius:6px;padding:10px;font-size:12px;font-family:'DM Sans',sans-serif;color:#374151;resize:vertical;outline:none;min-height:120px;" placeholder="Add case notes…"></textarea>
                        </div>
                    </div>
                </template>
                ...
                <template x-if="!selectedCaseId">
                    <div style="display:flex;flex-direction:column;align-items:center;justify-content:center;flex:1;padding:40px;text-align:center;">
                        <div style="width:56px;height:56px;background:#f5f0ff;border-radius:50%;display:flex;align-items:center;justify-content:center;margin-bottom:12px;">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#6a0f70" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="18" x="3" y="3" rx="2"/><circle cx="9" cy="9" r="2"/><path d="m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21"/></svg>
                        </div>
                ...
                <div>
                    ...
                    <div style="display:flex;align-items:center;gap:8px;">
                        ...
                        <input type="text" name="wm_{{ $key }}" id="wm_{{ $key }}"
                               ...
                               style="flex:1;border:1px solid #e5e7eb;border-radius:5px;padding:7px 10px;font-size:12px;font-family:'DM Sans',sans-serif;outline:none;transition:border-color .15s;"
