...
<div class="co-stats">
    ...
    <div class="co-stat co-stat--amber">
        ...
        <div class="co-stat__body">
            ...
            <span class="co-stat__value">{{ $stats['followups_due'] ?? 0 }}</span>
        </div>
    ...
    <div class="co-stat co-stat--red">
        ...
        <div class="co-stat__body">
            ...
            <span class="co-stat__value">{{ $stats['overdue'] ?? 0 }}</span>
        </div>
        <a href="{{ route('communication.manager.index', ['tab' => 'overdue']) }}" class="co-stat__cta co-stat__cta--red">Needs attention &rarr;</a>
    </div>
    ...
    <div class="co-box" style="margin-bottom:0">
        ...
        <div class="co-overview-grid">
            ...
            <div class="co-ov co-ov--red">
                ...
                <span class="co-ov__value">{{ $stats['overdue'] ?? 0 }}</span>
                <span class="co-ov__desc">Missed follow-ups</span>
                <a href="{{ route('communication.manager.index', ['tab' => 'overdue']) }}" class="co-ov__cta">View Overdue &rarr;</a>
            </div>
            ...
            <div class="co-ov co-ov--amber">
                ...
                <span class="co-ov__value">{{ $stats['today_count'] ?? 0 }}</span>
            ...
            <div class="co-ov co-ov--blue">
                ...
                <span class="co-ov__value">{{ $stats['whatsapp_pending'] ?? 0 }}</span>
...
<div class="co-metrics">
    ...
    <div class="co-metric">
        ...
        <div class="co-metric__body">
            ...
            <span class="co-metric__value">{{ $metrics['total_leads'] ?? 0 }}</span>
    ...
    <div class="co-metric">
        ...
        <div class="co-metric__body">
            ...
            <span class="co-metric__value">{{ $metrics['total_calls'] ?? 0 }}</span>
    ...
    <div class="co-metric">
        ...
        <div class="co-metric__body">
            ...
            <span class="co-metric__value">{{ $metrics['followups_completed'] ?? 0 }}</span>
    ...
    <div class="co-metric">
        ...
        <div class="co-metric__body">
            ...
            <span class="co-metric__value">{{ $metrics['conversion_rate'] ?? '0%' }}</span>
