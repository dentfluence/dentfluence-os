...
{{-- PREVIEW NOTICE — sample data until TimelineController is wired to live records. 2026-06-26 --}}
<div style="margin:10px 20px 0;padding:10px 14px;border:1px solid var(--comm-warning);background:var(--comm-warning-bg);color:var(--comm-warning-text);border-radius:8px;font-size:13px;font-family:var(--comm-font);">
    <strong>Preview:</strong> This timeline is showing sample data and is not yet connected to live records.
</div>
