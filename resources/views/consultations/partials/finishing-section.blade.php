...
--}}
@php
    $recallOptions   = ['1 Day','3 Days','5 Days','1 Week','2 Weeks','1 Month','3 Months','6 Months','Custom'];
    ...
    <div x-show="open" x-collapse style="padding:18px;display:grid;grid-template-columns:1fr 1fr 1fr 1fr;gap:16px;">
        ...
        <div>
            ...
            <div style="display:flex;flex-wrap:wrap;gap:5px;margin-top:4px;">
                @foreach($recallOptions as $ri)
                <button type="button"
                        @click="form.finishing.recall_interval='{{ $ri }}'"
            ...
            <input x-show="form.finishing.recall_interval === 'Custom'"
                   type="text"
                   x-model="form.finishing.recall_custom"
                   class="df-input"
