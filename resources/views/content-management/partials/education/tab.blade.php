...
<div x-data="eduTab()" x-init="init()" style="padding:20px;">
    ...
    <div x-show="!loading && items.length === 0" style="text-align:center;padding:60px;color:#9ca3af;">
        <div style="width:56px;height:56px;border-radius:50%;background:#f5f3ff;margin:0 auto 14px;display:flex;align-items:center;justify-content:center;">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#6a0f70" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>
        </div>
