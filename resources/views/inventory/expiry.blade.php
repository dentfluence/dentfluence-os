    ...
    <table style="width:100%;border-collapse:collapse;font-size:13px;">
        ...
        <tbody>
            ...
            <tr style="border-bottom:1px solid rgba(185,92,183,0.05);transition:background 120ms;"
                ...
                <td style="padding:11px 14px;font-family:'Inter', sans-serif;font-size:12px;color:#4e2060;">{{ $mv->batch_no ?: '—' }}</td>
                <td style="padding:11px 14px;font-size:12.5px;color:#2e1040;">{{ $mv->toLocation?->name ?? 'Main Store' }}</td>
                <td style="padding:11px 14px;text-align:center;font-family:'Inter', sans-serif;font-weight:600;color:#1e0a2c;">
