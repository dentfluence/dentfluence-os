...
<div style="max-width:560px;margin:0 auto;">
    <div class="df-card">
        <div class="df-card-header">
            ...
            <div style="width:40px;height:40px;background:#e8f7ef;border-radius:50%;display:flex;align-items:center;justify-content:center;">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#1a7a45" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 5v14M5 12l7-7 7 7"/></svg>
            </div>
        </div>
                ...
                <div style="display:flex;flex-direction:column;gap:16px;">
                    ...
                    <div>
                        ...
                        <select name="inventory_item_id" required id="stockin-item"
                            style="width:100%;padding:9px 12px;border:1px solid rgba(185,92,183,0.25);border-radius:3px;font-size:13px;font-family:'DM Sans',sans-serif;color:#1e0a2c;outline:none;">
                        ...
                        <div>
                            ...
                            <div style="display:flex;align-items:center;gap:6px;">
                                <input type="number" name="qty" required min="0.01" step="0.01" placeholder="0"
                                    style="flex:1;padding:9px 12px;border:1px solid rgba(185,92,183,0.25);border-radius:3px;font-size:13px;font-family:'DM Mono',monospace;outline:none;">
                                <span id="stockin-unit" style="font-size:12px;color:#9a85aa;white-space:nowrap;min-width:30px;">units</span>
                            </div>
                        </div>
                        <div>
                            <label style="display:block;font-size:12px;font-weight:500;color:#4e2060;margin-bottom:6px;">Unit Cost (₹)</label>
                            <input type="number" name="unit_cost" id="stockin-price" min="0" step="0.01" placeholder="0.00"
                                style="width:100%;padding:9px 12px;border:1px solid rgba(185,92,183,0.25);border-radius:3px;font-size:13px;font-family:'DM Mono',monospace;outline:none;box-sizing:border-box;">
                        </div>
                    </div>
                    ...
                    <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px;">
                        ...
                        <div>
                            ...
                            <input type="date" name="expiry_date"
                                style="width:100%;padding:9px 12px;border:1px solid rgba(185,92,183,0.25);border-radius:3px;font-size:13px;font-family:'DM Sans',sans-serif;outline:none;box-sizing:border-box;">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="notes" rows="2" placeholder="Supplier, invoice no., remarks…"
                            style="width:100%;padding:9px 12px;border:1px solid rgba(185,92,183,0.25);border-radius:3px;font-size:13px;font-family:'DM Sans',sans-serif;outline:none;resize:vertical;box-sizing:border-box;"></textarea>
                    </div>

                    <div style="display:flex;gap:10px;padding-top:4px;">
                        <button type="submit"
                            style="flex:1;padding:11px;background:#1a7a45;color:#fff;border:none;border-radius:3px;font-size:13px;font-weight:500;cursor:pointer;font-family:'DM Sans',sans-serif;display:flex;align-items:center;justify-content:center;gap:6px;">
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
                            Confirm Stock In
                        </button>
                        <a href="{{ route('inventory.index') }}"
                            style="padding:11px 20px;background:#fff;color:#6a0f70;border:1px solid rgba(106,15,112,0.25);border-radius:3px;font-size:13px;cursor:pointer;font-family:'DM Sans',sans-serif;text-decoration:none;display:flex;align-items:center;">
                            Cancel
                        </a>
                    </div>
                </div>
    ...
    <div style="margin-top:20px;">
        ...
        <div style="background:#fff;border:1px solid rgba(185,92,183,0.08);border-radius:4px;padding:11px 16px;margin-bottom:8px;display:flex;align-items:center;justify-content:space-between;">
            ...
            <div style="font-family:'DM Mono',monospace;font-weight:600;color:#1a7a45;font-size:15px;">+{{ number_format($mv->qty,1) }}</div>
        </div>
        @empty
