...
<div style="max-width:560px;margin:0 auto;">
    <div class="df-card">
        <div class="df-card-header">
            ...
            <div style="width:40px;height:40px;background:#fdeaea;border-radius:50%;display:flex;align-items:center;justify-content:center;">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#b52020" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 19V5M5 12l7 7 7-7"/></svg>
            </div>
        </div>
            ...
            <form action="{{ route('inventory.stock-out.store') }}" method="POST">
                ...
                <div style="display:flex;flex-direction:column;gap:16px;">
                    ...
                    <div style="display:flex;gap:10px;padding-top:4px;">
                        <button type="submit"
                            style="flex:1;padding:11px;background:#b52020;color:#fff;border:none;border-radius:3px;font-size:13px;font-weight:500;cursor:pointer;font-family:'DM Sans',sans-serif;display:flex;align-items:center;justify-content:center;gap:6px;">
    ...
    <div style="margin-top:20px;">
        ...
        <div style="background:#fff;border:1px solid rgba(185,92,183,0.08);border-radius:4px;padding:11px 16px;margin-bottom:8px;display:flex;align-items:center;justify-content:space-between;">
            ...
            <div style="font-family:'DM Mono',monospace;font-weight:600;color:#b52020;font-size:15px;">{{ number_format($mv->qty,1) }}</div>
        </div>
        @empty
        ...
        .then(data => {
            ...
            infoBox.innerHTML = `
                <span style="display:inline-flex;align-items:center;gap:5px;
                    ...
                    ${icon} Available: <strong style="font-family:'DM Mono',monospace;">
