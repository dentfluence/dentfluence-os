    ...
    <table style="width:100%;border-collapse:collapse;font-size:13px;">
        ...
        <tbody>
            ...
            <tr style="border-bottom:1px solid rgba(185,92,183,0.05);transition:background 120ms;"
                ...
                <td style="padding:12px 14px;font-family:'DM Mono',monospace;font-size:12px;color:#4e2060;">{{ $vendor->gst_no ?? '—' }}</td>
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px;">
                ...
                <div>
                    ...
                    <input type="text" name="gst_no" placeholder="29AABCU9603R1ZX"
                        style="width:100%;padding:8px 12px;border:1px solid rgba(185,92,183,0.25);border-radius:3px;font-size:13px;font-family:'DM Mono',monospace;outline:none;box-sizing:border-box;">
                </div>
                <div>
                ...
                <div style="grid-column:1/-1;">
                    ...
                    <textarea name="address" rows="2" placeholder="Full address"
                        style="width:100%;padding:8px 12px;border:1px solid rgba(185,92,183,0.25);border-radius:3px;font-size:13px;font-family:'DM Sans',sans-serif;outline:none;resize:vertical;box-sizing:border-box;"></textarea>
                </div>
            </div>
            <div style="display:flex;gap:10px;margin-top:20px;padding-top:16px;border-top:1px solid rgba(185,92,183,0.08);">
                <button type="submit" style="flex:1;padding:10px;background:#6a0f70;color:#fff;border:none;border-radius:3px;font-size:13px;font-weight:500;cursor:pointer;font-family:'DM Sans',sans-serif;">Save Vendor</button>
                <button type="button" onclick="document.getElementById('modal-add-vendor').style.display='none'" style="padding:10px 20px;background:#fff;color:#6a0f70;border:1px solid rgba(106,15,112,0.25);border-radius:3px;font-size:13px;cursor:pointer;font-family:'DM Sans',sans-serif;">Cancel</button>
            </div>
        </form>
    </div>
</div>
...
<div id="modal-edit-vendor" style="display:none;position:fixed;inset:0;z-index:60;align-items:center;justify-content:center;background:rgba(14,1,24,0.55);backdrop-filter:blur(3px);">
    <div style="background:#fff;border-radius:6px;width:100%;max-width:560px;max-height:90vh;overflow-y:auto;box-shadow:0 20px 60px rgba(14,1,24,0.25);margin:16px;">
        ...
        <form id="form-edit-vendor" method="POST" action="" style="padding:24px;">
            ...
            <div style="display:flex;gap:10px;margin-top:20px;padding-top:16px;border-top:1px solid rgba(185,92,183,0.08);">
                <button type="submit" style="flex:1;padding:10px;background:#6a0f70;color:#fff;border:none;border-radius:3px;font-size:13px;font-weight:500;cursor:pointer;font-family:'DM Sans',sans-serif;">Save Changes</button>
                <button type="button" onclick="document.getElementById('modal-edit-vendor').style.display='none'" style="padding:10px 20px;background:#fff;color:#6a0f70;border:1px solid rgba(106,15,112,0.25);border-radius:3px;font-size:13px;cursor:pointer;font-family:'DM Sans',sans-serif;">Cancel</button>
            </div>
        </form>
    </div>
</div>
