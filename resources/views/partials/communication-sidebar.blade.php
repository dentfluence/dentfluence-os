<aside class="comm-sidebar" id="commSidebar">
    ...
    <a href="{{ route('communication.prm.index') }}"
       class="comm-nav-item {{ request()->routeIs('communication.prm.index') ? 'comm-nav-item--active' : '' }}">
        <i class="ti ti-users"></i>
        <span>Leads</span>
    </a>

    <a href="{{ route('communication.prm.board') }}"
       class="comm-nav-item {{ request()->routeIs('communication.prm.board') || request()->routeIs('communication.prm.*') ? 'comm-nav-item--active' : '' }}">
    ...
    <a href="{{ route('communication.prm.settings') }}"
       class="comm-nav-item {{ request()->routeIs('communication.prm.settings') ? 'comm-nav-item--active' : '' }}">
