...
<nav id="df-sidebar-nav" aria-label="Main navigation">
    ...
    <div style="padding: 12px 0 8px;">
        ...
        {{-- Settings Architecture v2: renamed "Settings" → "Clinic Administration".
             Same route, same icon, same single sidebar entry — frozen decision #1
             keeps the sidebar clean; module settings live inside their own module. --}}
        @include('components.sidebar-item', [
