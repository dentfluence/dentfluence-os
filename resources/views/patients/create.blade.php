...
<style>
    ...
    * { box-sizing: border-box; }
    ...
    .ext-input { width:100%; border:none; outline:none; font-size:13px; color:#111827; font-family:'DM Sans',sans-serif; background:transparent; }
    .ext-textarea { width:100%; border:none; outline:none; font-size:13px; color:#111827; font-family:'DM Sans',sans-serif; resize:none; background:transparent; }
...
@section('content')
<div x-data="consultBrain()" x-init="init()" style="font-family:'DM Sans',sans-serif;">
...
<div id="consult-topbar">
    <div style="display:flex;align-items:center;gap:12px;">
        ...
        {{-- View toggle --}}
        <div style="display:flex;gap:3px;margin-left:12px;border:1px solid #e5e7eb;border-radius:4px;padding:2px;">
            <button x-on:click="viewMode='brain'"
                :style="viewMode==='brain' ? 'background:#6a0f70;color:white;' : 'background:transparent;color:#6b7280;'"
                style="padding:3px 10px;font-size:11px;font-weight:600;border:none;border-radius:3px;cursor:pointer;transition:all .15s;">
                🧠 Brain Mode
            </button>
            <button x-on:click="viewMode='form'"
                :style="viewMode==='form' ? 'background:#6a0f70;color:white;' : 'background:transparent;color:#6b7280;'"
                style="padding:3px 10px;font-size:11px;font-weight:600;border:none;border-radius:3px;cursor:pointer;transition:all .15s;">
                📋 Form Mode
            </button>
        </div>
                    ...
                    <div style="display:flex;gap:6px;margin-top:2px;">
                        ...
                        <button type="button" x-on:click="form.treatment_acceptance = '{{ $val }}'"
                            :style="form.treatment_acceptance === '{{ $val }}'
                                ? 'background:#6a0f70;color:white;border-color:#6a0f70;'
                                : 'background:white;color:#6b7280;border-color:#e5e7eb;'"
                            style="padding:4px 10px;font-size:11px;font-weight:600;border:1px solid;border-radius:3px;cursor:pointer;transition:all .15s;">
                            {{ $lbl }}
                        </button>
                        @endforeach
                    </div>
