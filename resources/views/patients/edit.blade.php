...
<div class="min-h-screen" style="background:#f5eef9;">
    ...
    <div class="flex items-center justify-between px-8 py-5 border-b border-purple-100 bg-white">
        <div>
            <p class="text-xs tracking-widest uppercase" style="color:#6a0f70;font-family:'DM Sans',sans-serif;">Patient Record</p>
    ...
    <form action="{{ route('patients.update', $patient) }}" method="POST" class="px-8 py-8 max-w-5xl mx-auto space-y-8">
        ...
        @if($errors->any())
        <div class="border border-red-300 bg-red-50 px-5 py-4 text-sm" style="font-family:'DM Sans',sans-serif;color:#991b1b;">
        ...
        <div class="bg-white border border-purple-100 overflow-hidden">
            <div class="px-6 py-4 border-b border-purple-100 flex items-center gap-3" style="background:#faf5fb;">
                ...
                <span class="text-xs tracking-widest uppercase" style="font-family:'DM Sans',sans-serif;color:#6a0f70;font-weight:600;">Personal Information</span>
            </div>
            <div class="p-6 grid grid-cols-1 md:grid-cols-3 gap-5">

                <div class="md:col-span-2">
                    <label class="block text-xs tracking-widest uppercase mb-1.5" style="font-family:'DM Sans',sans-serif;color:#380740;">Full Name <span class="text-red-500">*</span></label>
                ...
                <div>
                    <label class="block text-xs tracking-widest uppercase mb-1.5" style="font-family:'DM Sans',sans-serif;color:#380740;">Phone <span class="text-red-500">*</span></label>
                ...
                <div>
                    <label class="block text-xs tracking-widest uppercase mb-1.5" style="font-family:'DM Sans',sans-serif;color:#380740;">Date of Birth</label>
                ...
                <div>
                    <label class="block text-xs tracking-widest uppercase mb-1.5" style="font-family:'DM Sans',sans-serif;color:#380740;">Gender</label>
                    <select name="gender" class="w-full border border-purple-200 px-3 py-2.5 text-sm focus:outline-none focus:border-purple-500 bg-white" style="font-family:'DM Sans',sans-serif;color:#1a0020;">
                ...
                <div>
                    <label class="block text-xs tracking-widest uppercase mb-1.5" style="font-family:'DM Sans',sans-serif;color:#380740;">Email</label>
        ...
        <div class="bg-white border border-purple-100 overflow-hidden">
            <div class="px-6 py-4 border-b border-purple-100 flex items-center gap-3" style="background:#faf5fb;">
                ...
                <span class="text-xs tracking-widest uppercase" style="font-family:'DM Sans',sans-serif;color:#6a0f70;font-weight:600;">Address</span>
            </div>
            <div class="p-6 grid grid-cols-1 md:grid-cols-3 gap-5">

                <div class="md:col-span-3">
                    <label class="block text-xs tracking-widest uppercase mb-1.5" style="font-family:'DM Sans',sans-serif;color:#380740;">Street Address</label>
                ...
                <div>
                    <label class="block text-xs tracking-widest uppercase mb-1.5" style="font-family:'DM Sans',sans-serif;color:#380740;">City</label>
                ...
                <div>
                    <label class="block text-xs tracking-widest uppercase mb-1.5" style="font-family:'DM Sans',sans-serif;color:#380740;">State</label>
                ...
                <div>
                    <label class="block text-xs tracking-widest uppercase mb-1.5" style="font-family:'DM Sans',sans-serif;color:#380740;">Pincode</label>
        ...
        <div class="bg-white border border-purple-100 overflow-hidden">
            ...
            <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                    <label class="block text-xs tracking-widest uppercase mb-1.5" style="font-family:'DM Sans',sans-serif;color:#380740;">Chief Complaint</label>
                    <textarea name="chief_complaint" rows="3"
                              ...
                              style="font-family:'DM Sans',sans-serif;color:#1a0020;">{{ old('chief_complaint', $patient->chief_complaint) }}</textarea>
                </div>

                <div>
                    <label class="block text-xs tracking-widest uppercase mb-1.5" style="font-family:'DM Sans',sans-serif;color:#380740;">Medical Alert</label>
                    <textarea name="medical_alert" rows="3"
                              class="w-full border border-purple-200 px-3 py-2.5 text-sm focus:outline-none focus:border-purple-500 bg-white resize-none"
                              style="font-family:'DM Sans',sans-serif;color:#1a0020;">{{ old('medical_alert', $patient->medical_alert) }}</textarea>
                    <p class="mt-1 text-xs" style="font-family:'DM Sans',sans-serif;color:#9d6ea8;">Allergies, conditions, medications</p>
                </div>
        ...
        <div class="bg-white border border-purple-100 overflow-hidden">
            <div class="px-6 py-4 border-b border-purple-100 flex items-center gap-3" style="background:#faf5fb;">
                ...
                <span class="text-xs tracking-widest uppercase" style="font-family:'DM Sans',sans-serif;color:#6a0f70;font-weight:600;">Source & Referral</span>
            </div>
            <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-5">

                <div>
                    <label class="block text-xs tracking-widest uppercase mb-1.5" style="font-family:'DM Sans',sans-serif;color:#380740;">Source</label>
                    <select name="source" class="w-full border border-purple-200 px-3 py-2.5 text-sm focus:outline-none focus:border-purple-500 bg-white" style="font-family:'DM Sans',sans-serif;color:#1a0020;">
                        <option value="">— Select —</option>
                ...
                <div>
                    <label class="block text-xs tracking-widest uppercase mb-1.5" style="font-family:'DM Sans',sans-serif;color:#380740;">Referred By</label>
        ...
        <div class="flex items-center justify-between pt-2">
            ...
            <button type="submit"
                    ...
                    style="background:#6a0f70;font-family:'DM Sans',sans-serif;font-weight:500;">
                Save Changes
            </button>
        </div>
