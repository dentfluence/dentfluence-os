...
@php
    ...
    $hasActiveFilter = collect(['gender','area','age_min','age_max','membership','follow_up','source','birthday_month'])
...
<div class="flex items-center justify-between mb-5">
    <div>
        ...
        <p class="text-sm text-gray-500 mt-0.5">
            ...
            @if(request()->hasAny(['q','gender','area','membership','follow_up','source','birthday_month','age_min','age_max']))
...
<form method="GET" action="{{ route('patients.index') }}" id="filter-form">
    ...
    <div class="flex gap-2 mb-3">
        ...
        <select name="sort" onchange="this.form.submit()"
            ...
            <option value="patient_id" {{ request('sort') === 'patient_id' ? 'selected' : '' }}>Patient ID</option>
        ...
        <button type="button"
            ...
            Filters
            @php
                $activeFilters = collect(['gender','area','age_min','age_max','membership','follow_up','source','birthday_month'])
        ...
        @if(request()->hasAny(['q','gender','area','age_min','age_max','membership','follow_up','source','birthday_month']))
    ...
    <div x-show="filtersOpen" x-transition class="mb-4 border border-gray-200 bg-white p-4 grid grid-cols-2 md:grid-cols-4 gap-4" x-cloak>
        ...
        <div>
            ...
            <input type="text" name="area" value="{{ request('area') }}" placeholder="e.g. Bandra"
                class="w-full border border-gray-200 text-sm px-3 py-2 focus:outline-none focus:border-[#6a0f70]" />
        </div>
