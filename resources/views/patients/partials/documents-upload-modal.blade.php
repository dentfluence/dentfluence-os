    ...
    <div class="relative w-full max-w-2xl max-h-[90vh] bg-white rounded-2xl shadow-2xl
        ...
        <div x-show="uploadStep === 2"
            ...
            <div class="space-y-5">
                ...
                {{-- ── Tooth Number — the ONE shared FDI chart ─────────── --}}
                {{-- This was ~200 lines of inline markup here. The File Viewer
                     needed the same chart to let a tooth be corrected after
                     upload, so it moved to <x-tooth-chart> rather than being
                     copied — two charts would have drifted the way every other
                     duplicated thing in this module has. --}}
