                    ...
                    <div class="space-y-1">
                        ...
                        <div class="flex flex-wrap gap-3 text-xs text-gray-500">
                            ...
                            <template x-if="c.lab_cost">
                                <span>Cost: <strong x-text="'₹' + Number(c.lab_cost).toLocaleString('en-IN')"></strong></span>
                            </template>
                        </div>
            ...
            <form id="patient-lab-form" class="space-y-5" @submit.prevent="submitForm()">
                ...
                <div>
                    ...
                    <div class="flex gap-4 flex-wrap">
                        @foreach(['sent'=>'Sent','in_progress'=>'In Progress','received'=>'Received','rejected'=>'Rejected'] as $val => $lbl)
